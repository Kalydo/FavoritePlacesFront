        ...
        return(
            <div className="header">
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                    ...
                    <span className="navbar-brand text">My Favorite Places</span>
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul className="navbar-nav mr-auto mt-2 mt-md-0">
                            {isUserLoggedIn && <li className="nav-item"><Link className="nav-link" to="/my">My Favorite</Link></li>}
                            <li className="nav-item"><Link className="nav-link" to="/">Home</Link></li>
                        </ul>
                        <ul className="navbar-nav navbar-collapse justify-content-end">
                            {isUserLoggedIn && <li className="nav-item"><Link className="nav-link" to="/picture">Add Place</Link></li>}
                            {isUserLoggedIn && <li className="nav-item"><Link className="nav-link" to="/account">Profil</Link></li>}
